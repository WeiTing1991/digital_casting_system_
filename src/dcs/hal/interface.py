...
class DeviceStruct:
    ...
    Example:
        >>> param = DeviceStruct(
        ...     id="001",
        ...     var_name="mixer_speed",
        ...     var_name_IN="MAIN.rMixerRPM",
        ...     type="REAL",
        ...     active=True
        ... )
    ...
    var_name_IN: str = ""
    """PLC variable name used for actual ADS communication."""

    type: str = ""
    """Data type of the parameter (BOOL, INT, REAL, STRING, etc.)."""

    active: bool = False
    """Whether this parameter is currently active and should be used."""
