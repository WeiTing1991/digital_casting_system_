...
class AbbConfig:
  ...
  def __init__(self):
    ...
    # [s] avoid freezing the main thread forever in case controller (virtual or real) is not available.
    self.TIMEOUT = int(config["TIMEOUT"])
    # [s]    avoid freezing the main thread forever, for time consuming processes (slow motions)
